...
import { Plus, ChevronDown, ChevronRight, Link as LinkIcon, Calendar as CalendarIcon, Clock, Bot } from 'lucide-react';
import { useAuth } from '../../contexts/AuthContext';
import { Candidate, InterviewResult, InterviewStatus } from '../../types';
import Avatar from '../../components/ui/Avatar';
import ResumeScreeningModal from '../../components/recruitment/ResumeScreeningModal';
...
const PipelinePage: React.FC = () => {
    ...
    const handleScreenClick = (candidate: Candidate) => {
                                            ...
                                            <tr className="bg-slate-50">
                                                <td colSpan={5} className="p-4">
                                                    <div className="flex justify-between items-center mb-3">
                                                        ...
                                                        <Button onClick={() => handleScreenClick(candidate)} variant="secondary" size="sm" leftIcon={<Bot size={14}/>}>
